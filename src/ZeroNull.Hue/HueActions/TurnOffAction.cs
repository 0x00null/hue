...
{
    [HueAction("off", "Turn the lights off", "turn-off")]
    public class TurnOffAction : HueActionBase
    {
        public TurnOffAction(IAppStateStore stateStore, ILogger log)
            : base(stateStore, log)
        {
        }
